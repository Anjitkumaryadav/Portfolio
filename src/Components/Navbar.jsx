        ...
        <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 bg-white'>
            <div className='flex justify-between items-center h-16'>
                <div className='flex space-x-2'>
                   ...
                   <h1 className='font-semibold text-xl cursor-pointer'>Anj<span className='text-red-500'>i</span>t
                ...
                <ul className='hidden  md:flex space-x-8'>
                  ...
                  {menu ? <IoMdClose size={24} className='cursor-pointer'/> : <FiMenu size={24} className='cursor-pointer'/>} 
                  </div>
